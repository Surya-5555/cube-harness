...
class TIRToolConfig(ToolConfig):
    ...
    def make(self, container: Container | None = None) -> "TIRTool":
        return TIRTool(config=self)


class TIRTool(Tool):
    def __init__(self, config: TIRToolConfig) -> None:
        self.config = config
